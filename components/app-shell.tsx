  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="border-primary from-primary/20 to-brand-2/20 size-10 animate-spin rounded-full border-[3px] border-t-transparent bg-linear-to-br" />
      </div>
    );
  }
    ...
    <SidebarProvider dir="ltr">
      ...
      <SidebarInset dir={dir}>
        <div className="relative flex min-h-svh flex-1 flex-col">
          ...
          <AppHeader user={user} />
          <main className="mx-auto w-full max-w-350 flex-1 p-4 sm:p-6 lg:p-8">
